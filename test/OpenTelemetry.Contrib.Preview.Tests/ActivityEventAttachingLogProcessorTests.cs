...
namespace OpenTelemetry.Preview.Tests
{
    public sealed class ActivityEventAttachingLogProcessorTests : IDisposable
    {
            ...
            bool recordException = false)
        {
            ...
            if (sampled)
            {
                ...
                Assert.Equal("OpenTelemetry.Preview.Tests.ActivityEventAttachingLogProcessorTests", tags[nameof(LogRecord.CategoryName)]);
